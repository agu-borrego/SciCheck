...
from settings           import N_THREADS, DATASET, PATH_TRAIN, PATH_RELS, MAX_CONTEXT_SIZE, EMB_METHOD
...
if __name__ == "__main__":  # This has to be explicitly done to launch processes
    ...
    settings.EMB_SIZE = None

    # Generate the csvs that contain the features associated to the triples
    processes = [Process(target=worker, args=(i, embeddings_dict)) for i in range(N_THREADS)]
